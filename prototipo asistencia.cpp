...
int main(){
     ...
     switch(opcion){
        ...
        cout<<endl;
        break;
        case 0: cout<<"Sistema de Asistencia Finalizado"<<endl;
        break;
        default: cout<<"El valor ingresado es Incorrecto,digite una nueva opcion \n"<<endl;
        break;
    }
    }while(opcion != 0);
    guardarRegistro();
...
{
    ifstream archivo;
    archivo.open("Lista_Asistencia.txt", ios::in);
    string lista;
...
void guardarRegistro(){
     ...
     ofstream Guardar;
     Guardar.open("Lista_Asistencia.txt",ios::out);
